        ...
        return (
            <div>
                ...
                <div id='new-punch'>
                    ...
                    <div id='day'>
                        <h2>Day: </h2>
                        <select name="day" onChange={e => this.handleChange('day', e)}>
                    ...
                    <div id='type'>
                        <h2>Punch Type: </h2>
                        <select name="type" onChange={e => this.handleChange('kind', e)}>
                    ...
                    <div id='buttons'>
                        <Link to='/'>
                            <button className='blue button' onClick={() => this.newPunch()}>Create Punch</button>
                        </Link>
                        <Link to='/'>
